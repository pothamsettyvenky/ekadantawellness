    ...
    <section className="about-doctor">
      <div className="about-doctor-container">
        ...
        <div className="doctor-content" data-aos="fade-left">
          <p className="doctor-tag">MEET YOUR DOCTOR</p>

          <h2>Dr. S. Shripriya</h2>
          ...
          <p className="doctor-description">
            ...
            combines Homoeopathy with deep understanding of emotional wellbeing,
            lifestyle and overall health to create long-term wellness solutions.
          </p>
